...
Swift.prototype.listContainers = function(callback) {
  request.call(this, {
      path: '/' + this.options.version + '/' + this.account + '?format=json'
  }, callback);
};
...
Swift.prototype.retrieveAccountMetadata = function(callback) {
  request.call(this, {
      path: '/' + this.options.version + '/' + this.account
    , method: 'HEAD'
  }, callback);
};
...
Swift.prototype.listObjects = function(object, callback) {
  request.call(this, {
      path: '/' + this.options.version + '/' + this.account + '/' + object + '?format=json'
  }, callback);
};
...
Swift.prototype.createContainer = function(container, callback) {
  request.call(this, {
      path: '/' + this.options.version + '/' + this.account + '/' + container
    , method: 'PUT'
  }, callback);
};
...
Swift.prototype.deleteContainer = function(container, callback) {
  var self = this
    ...
    , remove = function() {
      request.call(self, {
          path: '/' + this.options.version + '/' + self.account + '/' + container
        , method: 'DELETE'
      }, callback);
    };
...
Swift.prototype.getFile = function(container, object, callback, res) {
  request.call(this, {
      path: '/' + this.options.version + '/' + this.account + '/' + container + '/' + object
  }, callback, {
      res: res
  });
};
...
Swift.prototype.copyObject = function(container, destObject, fromContainer, sourceObject, callback) {
  request.call(this, {
      path: '/' + this.options.version + '/' + this.account + '/' + container + '/' + destObject
    , method: 'PUT'
    , headers: {
        'X-Auth-Token': this.token
